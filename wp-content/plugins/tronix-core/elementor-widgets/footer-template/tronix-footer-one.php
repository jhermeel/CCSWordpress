...
class tronix_footer_one_widget extends Widget_Base {

    public function get_name() {

        return 'tronix_footer_one';
    }

    public function get_title() {
        return esc_html__( 'Tronix Footer template One ', 'tronixcore' );
    }
...
// ----------------------------------------------
		...
		$this->start_controls_section(
			'footer_icon_box',
			[
				'label' => esc_html__( 'Footer Icon Box', 'tronixcore' ),
				'tab'   => Controls_Manager::TAB_CONTENT,
			]
		);
		$this->add_control(
            ...
            [
                'label'        => esc_html__( 'Enable Icon Box Area', 'tronixcore' ),
		...
		$repeater->add_control(
			...
			[
				'label' => esc_html__( 'Title', 'tronixcore' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( 'Location', 'tronixcore' ),
                'label_block'   => true,
			]
		);
		$repeater->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( '258 Daniel Mansion 258
				Berlin Germany', 'tronixcore' ),
                'label_block'   => true,
			]
		);
		$this->add_control(
            'icon_box_list',
            [
                'label'   => esc_html__( 'box_List', 'tronixcore' ),
                'type'    => \Elementor\Controls_Manager::REPEATER,
                'fields'  => $repeater->get_controls(),
                'default' => [
                    [
                        'foote_Icon_Title' => esc_html__( 'Location', 'tronixcore' ),
						'footer_icon_des' => esc_html__( '258 Daniel Mansion 258
						Berlin Germany', 'tronixcore', 'tronixcore' ),
                    ],
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'types'    => ['classic', 'gradient', 'video'],
                'selector' => '{{WRAPPER}} .footer-one-wrapper',
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .footer-one-content-wrp',
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .footer-one-content-wrp' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .footer-one-content-wrp' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_section();
		...
		$this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Footer Bottom Style', 'tronixcore' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_group_control(
            \Elementor\Group_Control_Background::get_type(),
            [
                'name'     => 'footer_bottom_box_bg',
                'label'    => esc_html__( 'Background', 'tronixcore' ),
                'types'    => ['classic', 'gradient', 'video'],
                'selector' => '{{WRAPPER}} .footer-one-icon-box',
            ]
        );
		$this->add_responsive_control(
            'border_width',
            [
                'label'      => esc_html__( 'Border Width', 'tronixcore' ),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'range'      => [
                    'px' => [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .footer-one-icon-box' => 'border-width: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .footer-one-content-wrp' => 'border-width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
		$this->add_responsive_control(
			'footer_boxttom_box_border_color',
			[
				'label'       => esc_html__('Border Color', 'tronixcore'),
				'type'        => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .footer-one-content-wrp' => 'border-color: {{VALUE}};',
					'{{WRAPPER}} .footer-one-icon-box' => 'border-color: {{VALUE}};',
				],
			]
		);
        $this->add_responsive_control(
            'footer_bottom_box_margin',
            [
                'label'      => esc_html__( 'Margin', 'tronixcore' ),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .footer-one-icon-box' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            'footer_bottom_box_padding',
            [
                'label'      => esc_html__( 'Padding', 'tronixcore' ),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .footer-one-icon-box' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .footer-one-icon' => 'font-size: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .footer-one-icon' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .footer-one-icon' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'type'      => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .footer-one-icon' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'label'    => esc_html__( 'Background', 'tronixcore' ),
                'types'    => ['classic', 'gradient', 'video'],
                'selector' => '{{WRAPPER}} .footer-one-icon',
            ]
        );
        $this->add_group_control(
            \Elementor\Group_Control_box_Shadow::get_type(),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .footer-one-icon' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .footer-one-icon' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .footer-one-icon' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .footer-one-icon svg' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __( 'Typography', 'tronixcore' ),
				'selector' => '{{WRAPPER}} .footer-icon-box-title',
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'type'        => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .footer-icon-box-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .footer-icon-box-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .footer-icon-box-title' => 'Padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_tab();
		...
		$this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Typography', 'tronixcore' ),
				'selector' => '{{WRAPPER}} .footer-icon-box-des',
			]
		);
		$this->add_responsive_control(
			'icon_box_des_color',
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .footer-icon-box-des' => 'color: {{VALUE}}',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .footer-icon-box-des' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors' => [
					'{{WRAPPER}} .footer-icon-box-des' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_tab();
	...
	protected function render() {
        ...
        <div class="footer-one-wrapper footer-wrapper">
											...
											<?php foreach($settings['tronix_social_icon_list'] as $social_icon):
												...
												<li>
													<a href="<?php echo esc_url($url); ?>" <?php echo $target . $nofollow;?> >  
														<?php \Elementor\Icons_Manager::render_icon( $social_icon['tronix_social_icon'], ['aria-hidden' => 'true'] );?>
													</a>
												</li>
											<?php endforeach ?>
										</ul>
			...
			<?php	if ( $settings['enable_footer_icon_area'] == 'yes' ) :?>
			<div class="footer-one-icon-box-wrapper">
				<div class="container">
					<div class="row">
						<?php foreach ( $settings['icon_box_list'] as $icon_box ): ?>
							<div class="col-xl-4 col-lg-4 col-md-6 ">
								<div class="footer-one-icon-box">
									<div class="footer-one-icon">
										<?php \Elementor\Icons_Manager::render_icon( $icon_box['footer_icon'], ['aria-hidden' => 'true'] );?>                                   
									</div>
									<div class="footer-one-icon-box-content">
										<div class="footer-icon-box-title"><?php echo esc_html( $icon_box['foote_Icon_Title'] ); ?> </div>
										<div class="footer-icon-box-des"> <?php echo esc_html( $icon_box['footer_icon_des'] ); ?> </div>
									</div>
								</div>
							</div>
						<?php endforeach; ?>
...
Plugin::instance()->widgets_manager->register( new tronix_footer_one_widget );
...
class services_four_widget extends Widget_Base {

    public function get_name() {

        return 'tronix_services_four';
    }

    public function get_title() {
        return esc_html__( 'Tronix Service V4', 'tronixcore' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Tronix Service V4', 'tronixcore' ),
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type'        => \Elementor\Controls_Manager::TEXT,
                'default'     => esc_html__( 'Project Discussion', 'tronixcore' ),
                'label_block' => true,
            ]
        );
        $repeater->add_control(
        ...
        $this->add_control(
            ...
            [
				...
				'default' => [
					[
						'title' => esc_html__( 'Project Discussion', 'tronixcore' ),
						'Description' => esc_html__( 'They may offer a range of services, from project-based work to ongoing support and maintenance.', 'tronixcore' ),
					],
                    [
						'title' => esc_html__( 'Testing & Trying', 'tronixcore' ),
						'Description' => esc_html__( 'They may offer a range of services, from project-based work to ongoing support and maintenance.', 'tronixcore' ),
					],
                    [
						'title' => esc_html__( 'Execute & install', 'tronixcore' ),
						'Description' => esc_html__( 'They may offer a range of services, from project-based work to ongoing support and maintenance.', 'tronixcore' ),
					],
				],
                'title_field' => '{{{ title }}}',
        ...
        $this->add_responsive_control(
			...
			[
				...
				'toggle' => true,
				'selectors' => [
					'{{WRAPPER}} .service-box-four' => 'text-align: {{VALUE}};',
				],
			]
		);
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .service-box-four',
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .service-box-four' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .service-box-four' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .service-box-four' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'    => esc_html__( 'Background', 'tronixcore' ),
                'types'    => ['classic', 'gradient'],
                'selector' => '{{WRAPPER}} .service-box-four:hover',
            ]
        );
        $this->add_group_control(
            \Elementor\Group_Control_Box_Shadow::get_type(),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .service-box-four:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_tab();
   ...
   // 
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .service-four-number',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .service-four-number' => 'color: {{VALUE}};',
				],
			]
		);
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            'button_color_after',
            [
                'label'     => esc_html__( 'Border Animation Color', 'tronixcore' ),
                'type'      => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .service-four-number:after' => 'background-color: {{VALUE}}',
                ],
            ]
        );
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .service-four-number' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
        $this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .service-four-number' => 'Padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
        ...
        $this->add_group_control(
            ...
            [
                'name'     => 'icon_typo',
                'selector' => '{{WRAPPER}} .service-four-icon',
            ]
        );
        $this->add_responsive_control(
            'services_icon_color',
            [
                ...
                'type'      => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .service-four-icon' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .service-four-icon svg' => 'width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .service-four-icon svg' => 'height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );  
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .service-four-icon' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .service-four-icon' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->end_controls_section();
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .service-four-title',
            ]
        );
        $this->add_responsive_control(
            'title_color',
            [
                ...
                'type'      => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .service-four-title' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .service-four-title a' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'type'      => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .service-box-four:hover .service-four-title' => 'color: {{VALUE}}',
                    '{{WRAPPER}} .service-box-four:hover .service-four-title a' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .service-four-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .service-four-title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'name'     => 'dec_typography',
                'selector' => '{{WRAPPER}} .services-four-des',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type'      => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .services-four-des' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .services-four-des' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .services-four-des' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
                    ...
                    <?php foreach ( $settings['tronix_repeater_list'] as $item ): ?>
                        <div class="<?php echo esc_attr($column); ?> ">
                            <div class="service-box-four ">
                                <div class="service-four-number"><?php echo esc_html($item['number']); ?></div>
                                <span></span>
...
Plugin::instance()->widgets_manager->register( new services_four_widget );
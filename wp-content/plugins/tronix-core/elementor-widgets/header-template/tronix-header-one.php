	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'type'        => Controls_Manager::COLOR,
				'selectors'   => [
					'{{WRAPPER}} .header-one-botton .theme-btns' => 'background-color: {{VALUE}};',
				],
			]
		);
		$this->add_responsive_control(
		...
		$this->add_responsive_control(
			...
			[
				...
				'type'        => Controls_Manager::COLOR,
				'selectors'   => [
					'{{WRAPPER}} .header-one-botton .theme-btns:hover' => 'background-color: {{VALUE}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				'label'       => esc_html__('Hover Text Color', 'tronixcore'),
				'type'        => Controls_Manager::COLOR,
				'selectors'   => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'type'        => Controls_Manager::COLOR,
				'selectors'   => [
					'{{WRAPPER}} .header-one-call-icon' => 'background-color: {{VALUE}};',
				],
			]
		);
		$this->add_responsive_control(
		...
		$this->add_responsive_control(
			...
			[
				'label'       => esc_html__('Small Color', 'tronixcore'),
				'type'        => Controls_Manager::COLOR,
				'selectors'   => [
                ...
                <div class="container ">
					<div class="row ">
						<div class="col-xl-4 col-lg-4 col-md-12 col-12 ">
							...
							<?php echo esc_html($settings['opening_time']); ?>
							</div>
						</div>
						<div class="col-xl-8 col-lg-8 col-md-12 col-12 header-one-top-right">
							...
							<div class="header-mail"> <?php \Elementor\Icons_Manager::render_icon( $settings['email_icon'], [ 'aria-hidden' => 'true' ] ); ?> 
								<?php echo esc_html($settings['email_text']); ?></div>
						</div>
					</div>
                </div>
            </div>

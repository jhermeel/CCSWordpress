<script type="text/template" id="rave_TemplateLibrary_templates">
	<div id="liteTemplateLibrary_toolbar">
		<div id="liteTemplateLibrary_toolbar-search">
			<label for="liteTemplateLibrary_search" class="elementor-screen-only"><?php esc_html_e( 'Search Templates:', 'tronixcore' ); ?></label>
			<input id="liteTemplateLibrary_search" placeholder="<?php esc_attr_e( 'Search', 'tronixcore' ); ?>">
		...
		<div id="liteTemplateLibrary_toolbar-filter" class="liteTemplateLibrary_toolbar-filter">
			<# if (rave.library.getTypeTags()) { var selectedTag = rave.library.getFilter( 'tags' ); #>
				...
				<# } else { #>
				<span class="liteTemplateLibrary_filter-btn"><?php esc_html_e( 'Filter', 'tronixcore' ); ?> <i class="eicon-caret-right"></i></span>
				<# } #>

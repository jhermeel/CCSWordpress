...
<script type="text/template" id="rave-liteTemplateLibrary_header-back">
	...
	<span><?php echo __( 'Back to Library', 'tronixcore' ); ?></span>
</script>
...
<script type="text/template" id="rave-TemplateLibrary_header-actions">
	<div id="liteTemplateLibrary_header-sync" class="elementor-templates-modal__header__item">
		<i class="eicon-sync" aria-hidden="true" title="<?php esc_attr_e( 'Sync Library', 'tronixcore' ); ?>"></i>
		<span class="elementor-screen-only"><?php esc_html_e( 'Sync Library', 'tronixcore' ); ?></span>
	</div>
</script>